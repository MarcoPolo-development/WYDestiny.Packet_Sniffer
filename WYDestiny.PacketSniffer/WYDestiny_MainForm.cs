...
namespace WYDestiny.PacketSniffer
{
    ...
    {
        private WYDestinyNetworkSniffer m_sniffer;
        ...
        private void Sniffer_PacketReceived(object sender, WYDestinyPacketEventArgs e)
        {
        ...
        private void logPacket(WYDestinyPacketEventArgs packet)
        {
        ...
        private void toolsSavePacket_Click(object sender, EventArgs e)
        {
            ...
            {
                SavePacketToFile(dgvPacketLog.CurrentRow.Tag as WYDestinyPacketEventArgs);
            }
        }
        ...
        private void ShowDetailsOfRow(int rowId)
        {
            ...
            detailForm.InitializePacketDetails(dgvPacketLog.Rows[rowId].Tag as WYDestinyPacketEventArgs);
        ...
        private async void toolsStartLogging_Click(object sender, EventArgs e)
        {
            if (m_sniffer == null)
            {
                StartWYDestinySniffing form = new StartWYDestinySniffing();
        ...
        private void SavePacketToFile(WYDestinyPacketEventArgs packet)
        {
            if(saveDialog == null)
            {
        ...
        WYDestiny_IgnoredPacketsForm ignorePacketsForm;

        private void menuOptionsIgnoredPackets_Click(object sender, EventArgs e)
        {
            if (ignorePacketsForm == null)
                ignorePacketsForm = new WYDestiny_IgnoredPacketsForm();
