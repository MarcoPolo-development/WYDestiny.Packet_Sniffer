...
{
    public static class WYDestinyMarshalHelper
    {
        /// Copies a given number of bytes from the source buffer at the specified offset to the destination buffer at the specified offset.
